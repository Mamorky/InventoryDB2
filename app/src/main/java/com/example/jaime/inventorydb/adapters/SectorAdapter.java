...
public class SectorAdapter extends RecyclerView.Adapter<SectorAdapter.SectorViewHolder> {
    ...
    public SectorAdapter(OnItemClickListener listener,ArrayList<Sector> sectors) {
     ...
     * @param
     */
    public SectorAdapter(ArrayList<Sector> sectorsModified, OnItemClickListener listener,ArrayList<Sector> sectors) {
        this.sectors = sectors;
        mListener = listener;
    ...
    public void onBindViewHolder(SectorViewHolder holder, int position) {
        ...
        holder.txvSectorName.setText(sectors.get(position).getSortname());
